...
export function HomeCApi({usecontextApi, setUsecontextApi}){

    function handleCheckbox(){
        setUsecontextApi((prevValue)=>!prevValue)
        console.log("Not using context Api");
    }
    return <div>
        <div style={{display:"flex", fontSize:"1.3em", justifyContent:"flex-end", backgroundColor:"silver"}}>
            <p>Use ContextApi:</p>
            <input type="checkbox" checked = {usecontextApi} onChange={handleCheckbox} style={{marginRight:"1.5em"}}/>
        </div>
